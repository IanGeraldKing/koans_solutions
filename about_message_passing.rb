...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Can act as visual aid for creating distance. We need to understand
    # that ruby is a language catered to facilitaring the programmer's experience
    # rather than optimizing for machine performance. Thus, it would make sense
    # that such a function would exist.
  end
